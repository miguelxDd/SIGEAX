...
?>
    <div class="card m-3 p-3">
        <div class="cad-header text-center">
            <h4>Paquete agregado</h4>
            <hr>
        </div>
        <div class="card-body">
            <form action="" method="post" id="formAgregarPaquete">
                <div id="btnEditar">
                    <a href="paquetesVendedor" class="btn btn-primary" type="button">Atrás</a>
                    <button class="btn btn-warning" type="button" id="editarInform"><i data-feather="edit" class="me-2 mb-1"></i>Editar información</button>
                </div>
                <div id="btnConfEditar">
                    <button class="btn btn-success" type="button" id="confeditarInform"><i data-feather="check" class="me-2 mb-1"></i>Editar información</button>                    
                ...
                <div class="card my-2 infoFormularios">
                    ...
                    <div class="card-body" id="formEntrega">
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-4 my-1" id="inputTipo_envio">
                                <input type="text" class="form-control" id="tipo_envio" name="tipo_envio">
                            </div>                            
                        </div>
                        <div class="row pe-2 mt-1" id="envioNormal1">
                            <label for="ruta" class="col-md-2 col-form-label my-1">Ruta:</label>
                            <div class="col-md-2 my-1">
                                <input type="text" class="form-control" id="ruta" name="ruta">
                            </div>
                            <label for="destino" class="col-md-1 col-form-label my-1">Destino:</label>
                            <div class="col-md-7 my-1">
                                <input type="text" class="form-control" id="destino" name="destino">
                            </div>
                        </div>
                        <div class="row" id="envioPersonalizado1">
                            <label for="direccion" class="col-md-2 col-form-label my-1">Dirección:</label>
                            <div class="col-md-7 my-1">
                    ...
                    <div class="card-body" id="formPaquete">
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-10 my-1">
                                <textarea class="form-control" name="descripcion_paquete" id="descripcion_paquete" rows="3"></textarea>
                            </div>
                            ...
                            <div id="verEstimacionCostoEnvio">
                                <label>La estimación del costo de envio fué: <strong id="labelEstimacionVer"></strong></label>
                            </div>
                            <div class="row" id="estimarCostoEnvio">
                                <label class="col-12 col-form-label mt-1">
...
?>
<script src="Vistas/Vendedor/js/verPaquete.js"></script>