...
<body>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    <strong>¡Éxito!</strong> Se registró al empleado correctamente. Volviendo a la administración de usuarios...
                                    <button type="button" class="btn-close"></button>
                                </div>
                                <div class="alert alert-warning alert-dismissible" role="alert">
    ...
    <script src="Vistas/Admin/js/registroEmpleado.js"></script>
    <script>
